...
public:
    ...
    QImage *textureColorImage = nullptr;
...
private: // need initialize
    ...
    Outcome *m_currentOutcome = nullptr;
    ...
    Outcome *m_postProcessedOutcome = new Outcome;
    ...
    std::vector<RiggerBone> *m_resultRigBones = nullptr;
    std::map<int, RiggerVertexWeights> *m_resultRigWeights = nullptr;
    bool m_isRigObsolete = false;
    Outcome *m_riggedOutcome = new Outcome;
    PosePreviewsGenerator *m_posePreviewsGenerator = nullptr;
    ...
    quint64 m_nextMeshGenerationId = 1;
