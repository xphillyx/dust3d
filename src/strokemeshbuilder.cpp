...
void StrokeMeshBuilder::reviseNodeBaseNormal(Node &node)
{
    ...
    // 0.966: < 15 degress
    if (QVector3D::dotProduct(node.traverseDirection, orientedBaseNormal) > 0.966) {
