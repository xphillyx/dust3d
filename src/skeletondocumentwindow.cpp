    ...
    m_exportPreviewWidget(nullptr)
{
    ...
    m_exportRenderedAsImageAction = new QAction(tr("Rendered Image (.png)..."), this);
    ...
    m_exportMenu->addAction(m_exportRenderedAsImageAction);
    ...
    connect(m_document, &SkeletonDocument::resultRigChanged, [=]() {
        rigWidget->rigWeightRenderWidget()->updateMesh(m_document->takeResultRigWeightMesh());
    });
